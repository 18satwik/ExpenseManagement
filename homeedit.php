...
?>
                                ...
                                <br><strong>Total Expenses :</strong> <span class="label label-danger" id='exptop'><?php
                                    ...
                                    ?></span>
                                <br><strong>Total Balance :</strong> <span class="label label-default"><?php
...
//$sql = "SELECT * FROM income WHERE date >= '$thiyear' AND date <= '$today' AND uid='$sid' AND isdel=0 ORDER by date";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo "<tr><td> " . $exdate . "</td> <td> " . $row["income"] . " </td><td> " . $row["tvalue"] . "</td> <td> <a href='homeedit.php?delincome=" . $row['id'] . "' class='btn btn-danger btn-sm' name='remove' value='remove'><span class='glyphicon glyphicon-remove white' aria-hidden='true'></span></a></td></tr>";
                                                        $inctotal+=$row["tvalue"];
                                                    }
                                                } else {
                                    ...
                                    <div class="panel panel-warning">
                                        ...
                                        <div class="panel-body">
                                            <div class="col-lg-8">
                                                ...
                                                <form action="homeedit.php" class="form-horizontal"  name="showexp" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group form_datetime" >      
                                                            <input class="form-control" size="60" type="text" value="<?php $dstart = date("01-m-Y");
                                        echo $dstart; ?>" id="datepicker1" name="startd" readonly placeholder="Start Date" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
...
?>
                                        ...
                                        while ($psum = $result->fetch_assoc()) {
                                            ...
                                            if ($ppsum != '') {
                                                ...
                                                echo ' Expenses <span class="label label-danger">NIL</span>';
                                            }
                                        }
                                        ?>
                                                    <?php
                                            ...
                                            <tr class="success"><th>Date</th> <th> Expense Description </th><th> Total Price</th><th>Delete</th></tr>
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            $exdate = strtotime($row["date"]);
                                                            $exdate = date('d M Y', $exdate);
                                                            echo "<tr><td> " . $exdate . "</td> <td> " . $row["pname"] . " </td><td> " . $row["pprice"] . "</td><td> <a href='homeedit.php?del=" . $row['id'] . "' id='del' class='btn btn-danger btn-sm' name='remove' value='remove'><span class='glyphicon glyphicon-remove white' aria-hidden='true'></span></a></td></tr>";
                                                        }
                                                    } else {
